    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.text}>Lets see the talent in Board games!</Text>
                <Image style={styles.quizImage} source={require('../assets/quizImage.jpg')}/>
                <Link style={styles.startbutton} to={'bgquiz'}>
                
                <TouchableOpacity  onPress={()=>this.props.navigation.navigate('bgquiz')}>
