    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.text}>Lets start your Geography quiz !</Text>
                <Image style={styles.quizImage} source={require('../assets/quizImage.jpg')}/>
                <Link style={styles.startbutton} to={'gequiz'}>
                
                <TouchableOpacity  onPress={()=>this.props.navigation.navigate('gequiz')}>
