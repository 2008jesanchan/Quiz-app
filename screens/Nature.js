    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Text style={styles.text}>Lets start your nature&science quiz!</Text>
                <Image style={styles.quizImage} source={require('../assets/quizImage.jpg')}/>
                <Link style={styles.startbutton} to={'Naturequiz'}>
                
                <TouchableOpacity  onPress={()=>this.props.navigation.navigate('Naturequiz')}>
